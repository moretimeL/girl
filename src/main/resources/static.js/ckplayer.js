...
function ckstyle() { //定义总的风格
    var ck = {
		...
		*/
        setup: '1,1,1,1,1,2,0,1,2,0,1,1,200,0,2,1,0,1,1,1,2,10,3,0,1,2,3000,0,0,1,0,1,1,1,1,1,1,250,0,90,0,0',
        /*
		...
		*/
		...
		以下是播放器自带的二个插件
		*/
        control_rel: 'related.swf,/vplayer/related.xml,0',
        /*
		视频结束显示精彩视频的插件
		...
		*/
        pm_repc: '',
		/*
		视频地址替换符，该功能主要是用来做简单加密的功能，使用方法很简单，请注意，只针对f值是视频地址的时候有效，其它地方不能使用。具体的请查看http://wx.quweitou.com/manual.php?id=4#title_25
		*/
        pm_spac: '|',
        /*
		...
		*/
		...
		/*
			跳过广告和播放结束时调用的js函数
		*/
        myweb: escape('9e560587a42e24347e4e82c4ca11c7f7,quweitou.com'),
        /*
		------------------------------------------------------------------------------------------------------------------
		...
		*/
        cpt_share: '/vplayer/share.xml',
        /*
		分享插件调用的配置文件地址
		调用插件开始
		*/
		cpt_subtitle_cn:'{font color="#FFFFFF" size="22" face="Microsoft YaHei,YaHei,微软雅黑,SimHei,黑体"}[$subtitle]{/font}',
...
(function() {
    var CKobject = {
		...
		embedSWF: function(C, D, N, W, H, V, P) {
            ...
            s += 'align="middle">';
            s += this.getparam(P)['v'];
            s += '<embed ShowTracker="true" ShowPositionControls="true"';
            s += this.getparam(P)['w'];
