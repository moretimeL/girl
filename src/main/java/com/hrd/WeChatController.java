...
public class WeChatController {
   ...
   // private String apiTicketUrl;
    ...
    private JSONObject getJsApiTicket(){
        ...
        JSONObject temp = getAccessToken();

        String requestUrl = apiTicketUrl.replace("ACCESS_TOKEN",  temp.getString("access_token"));
    ...
    public Map<String, String> makeWXTicket(String jsApiTicket, String url) {
       ...
       // log.info("String1=====>"+string1);
        ...
        log.info("url="+url);
        log.info("url="+jsApiTicket);
        log.info("url="+nonceStr);
        log.info("url="+timestamp);
        log.info("url="+signature);
